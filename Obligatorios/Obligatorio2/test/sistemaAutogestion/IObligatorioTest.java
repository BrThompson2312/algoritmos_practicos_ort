...
public class IObligatorioTest {
    ...
    public void testComprarEntrada() {
        ...
        ret = miSistema.registrarSala("Tango", 1);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
    ...
    public void testEliminarEvento_ERROR2() {
        ...
        ret = miSistema.comprarEntrada("54936798", "1234");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
    ...
    public void testCalificarEvento_ERROR2() {
        ...
        /* ERROR 2 : Evento no existe */
        ret = miSistema.calificarEvento("54936798", "4289", 5, "No deberia de suceder");
        assertEquals(Retorno.Resultado.ERROR_2, ret.resultado);
    }
    ...
    public void testCalificarEvento_ERROR3() {
        ...
        ret = miSistema.calificarEvento("54936798", "4289", 0, "No deberia de suceder");
        assertEquals(Retorno.Resultado.ERROR_3, ret.resultado);
    }
    ...
    public void testCalificarEvento_ERROR4() {
        ...
        ret = miSistema.calificarEvento("54936798", "4289", 2, "El peor evento que vivi en mi vida");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        
        /* ERROR 4 : El evento ya fue calificado por el cliente */
        ret = miSistema.calificarEvento("54936798", "4289", 3, "No deberia de suceder");
    ...
    public void testListarClientesDeEvento() {
        ...
        /* Creamos sala y cliente para el registro de un evento */
        ret = miSistema.registrarSala("Tango", 2);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ...
        ret = miSistema.registrarEvento("4289", "Tango", 2, fecha);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        
        ret = miSistema.comprarEntrada("12341234", "4289");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ret = miSistema.comprarEntrada("12341235", "4289");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ret = miSistema.comprarEntrada("12341236", "4289");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ...
        assertEquals("12341236-c3", ret.resultado);
    }
    ...
    public void testListaDeEsperaPorEvento() {
        ...
        ret = miSistema.registrarSala("Tango", 2);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ret = miSistema.registrarSala("Jazz", 2);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ...
        // Evento 2
        ret = miSistema.comprarEntrada("12341236", "1235");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ret = miSistema.comprarEntrada("12341237", "1235");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        
        // Clientes en espera
        ret = miSistema.comprarEntrada("12341238", "1234");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ret = miSistema.comprarEntrada("12341239", "1235");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ...
        assertEquals("12341238-1234#12341239-1235", ret.resultado);
    ...
    public void testDeshacerComprasDeEntradas() {
        ...
        /* Creamos sala y cliente para el registro de un evento */
        ret = miSistema.registrarSala("Danza", 30);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ret = miSistema.registrarSala("Tango", 30);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ...
        assertEquals("1234-12341235#1234-12341365#12345-52323214#12345-76532456", ret.resultado);
    }
    ...
    public void testEventoMejorPuntuado() {
        ...
        ret = miSistema.registrarSala("Tango", 30);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ret = miSistema.registrarSala("Jazz", 40);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ...
        ret = miSistema.comprarEntrada("11114445", "4289");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ret = miSistema.comprarEntrada("11114446", "4201");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        
        ret = miSistema.calificarEvento("11114445", "4289", 6, "Buen evento");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
        ret = miSistema.calificarEvento("11114446", "4201", 9, "El mejor evento que vivi en mi vida");
        assertEquals(Retorno.Resultado.OK, ret.resultado);

        ret = miSistema.eventoMejorPuntuado();
        assertEquals("4201-9", ret.resultado);
    ...
    public void testComprasDeCliente() {
        ...
        ret = miSistema.comprasDeCliente("54936798");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
    ...
    public void testComprasDeCliente_ERROR1() {
        ...
        ret = miSistema.registrarCliente("54936999", "Bruno");
        assertEquals(Retorno.Resultado.OK, ret.resultado);
